...
<aside class="warning"> We're still in the process of creating this new API documentation site, so not all API calls are documented here yet. You can find our legacy API docs <a href="http://dev.legacy.splitwise.com">here</a> along with several discussions in the comments. </aside>
